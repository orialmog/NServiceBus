...
class SerializeMessageConnectorEx : StageConnector<IOutgoingLogicalMessageContext, IOutgoingPhysicalMessageContext>
{
    public SerializeMessageConnectorEx(IMessageSerializer messageSerializer, MessageMetadataRegistry messageMetadataRegistry)
    {
    ...
    static readonly ILog log = LogManager.GetLogger<SerializeMessageConnectorEx>();
}
